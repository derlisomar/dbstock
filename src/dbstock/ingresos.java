...
public class ingresos extends javax.swing.JFrame {
    ...
    public ingresos() {
       ...
       setDefaultCloseOperation(this.DO_NOTHING_ON_CLOSE); //inabilida el uso del boton exit X
        ...
        metodoingreso.cmb_sucursal_INGRESO();
    ...
    private void initComponents() {
        ...
        jtable_caja1_INGRESO = new javax.swing.JTable();
        ...
        jtable_INGRESODETALLE = new javax.swing.JTable();
        ...
        jtable_caja1_INGRESO.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jtable_caja1_INGRESO.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtable_caja1_INGRESOMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(jtable_caja1_INGRESO);
        ...
        label_ingreso.setText("INGRESOS");
        ...
        jtable_INGRESODETALLE.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jtable_INGRESODETALLE);
    ...
    private void cmb_sucu_gastoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmb_sucu_gastoMouseClicked
        ...
        try {
            ...
            jtable_caja1_INGRESO.setModel(mod);

            TableColumnModel columnModel = jtable_caja1_INGRESO.getColumnModel();
    ...
    private void jtable_caja1_INGRESOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtable_caja1_INGRESOMouseClicked

        int n1 = jtable_caja1_INGRESO.getSelectedRow();
        String id1 = jtable_caja1_INGRESO.getValueAt(n1, 0).toString();
        id.setText(id1);

        int n2 = jtable_caja1_INGRESO.getSelectedRow();
        String id2 = jtable_caja1_INGRESO.getValueAt(n2, 1).toString();
        descri.setText(id2);

        int n3 = jtable_caja1_INGRESO.getSelectedRow();
        String id3 = jtable_caja1_INGRESO.getValueAt(n3, 2).toString();
        monto.setText(id3);
        
        monto_ingreso.setEnabled(true);
        monto_ingreso.requestFocus();

    }//GEN-LAST:event_jtable_caja1_INGRESOMouseClicked
        ...
        if(obs_ingreso.getText().isEmpty()){
            ...
            obs_ingreso.requestFocus();
               ...
               // }else{
                    ...
                    //JOptionPane.showMessageDialog(null, "Monto ingresado es mayor al que esta en caja");
    ...
    public static javax.swing.JTable jtable_INGRESODETALLE;
    public static javax.swing.JTable jtable_caja1_INGRESO;
